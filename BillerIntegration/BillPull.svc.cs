...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "BillPull" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select BillPull.svc or BillPull.svc.cs at the Solution Explorer and start debugging.

    public class BillPull : IBillerService
    {
        #region Properties
        ...
        public XElement BillPull_(string guid, XElement billPullRequest)
        {
